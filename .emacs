...
;; opa-mode
(autoload 'opa-js-mode "/usr/share/opa/utils/emacs/opa-js-mode.el" "OPA JS editing mode." t)
(autoload 'opa-classic-mode "/usr/share/opa/utils/emacs/opa-mode.el" "OPA CLASSIC editing mode." t)
...
(add-to-list 'load-path "/usr/share/ghc-mod-1.10.18/")
